...
if (!statusElement || !lastUpdatedElement || !tableBody || !refreshButton || !tableSection) {
...
async function loadLatestBlocks({ showLoadingStatus } = { showLoadingStatus: true }) {
  if (isFetchingBlocks) {
    return;
  }
...
const blockLastUpdatedElement = document.querySelector("[data-block-last-updated]");
const blockDetailsContainer = document.querySelector("[data-block-details]");

if (!blockForm || !blockInput || !blockSubmitButton || !blockStatusElement || !blockDetailsContainer) {
  throw new Error("Required elements for block lookup are missing");
}

const blockFieldMap = {
  "block-number": blockDetailsContainer.querySelector('[data-field="block-number"]'),
  timestamp: blockDetailsContainer.querySelector('[data-field="timestamp"]'),
  "block-hash": blockDetailsContainer.querySelector('[data-field="block-hash"]'),
  "parent-hash": blockDetailsContainer.querySelector('[data-field="parent-hash"]'),
  miner: blockDetailsContainer.querySelector('[data-field="miner"]'),
  "transaction-count": blockDetailsContainer.querySelector('[data-field="transaction-count"]'),
  ...
  "arkiv-entity": blockDetailsContainer.querySelector('[data-field="arkiv-entity"]'),
};
